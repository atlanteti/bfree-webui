    ...
    <div className="clientes-container">
      <div className="home-container">
        <div className="input-group">
          ...
          <Link className="btn btn-dark btn-search" to="/cadastrar">
            Cadastrar
          </Link>
        </div>
              ...
              : usuarios.map((usuario) => {
                  return (
                    <tr key={usuario.usr_cod}>
                      ...
                      <td>
                        {moment(usuario.usr_dtcreation).format(
                          "DD/MM/YYYY HH:mm"
                        )}
                      </td>
                      <td>
                        {moment(usuario.usr_dtupdate).format(
                          "DD/MM/YYYY HH:mm"
                        )}
                      </td>
                      ...
                      <td>
                        <Link
                          ...
                          to={`/editar/${usuario.usr_cod}`}
                        >
                          Editar
                        </Link>
                        <button
                          className="btn btn-dark"
                          onClick={() => deletarUsuario(usuario.usr_cod)}
                        >
                          Excluir
                        </button>
                      </td>
